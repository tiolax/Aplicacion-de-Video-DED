/*
  ...
  - Added the required column `aprobado` to the `Video` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_Video" ("descripcion", "fase", "fecha_de_registro", "id", "identificador", "titulo", "ua_id", "usuario_id") SELECT "descripcion", "fase", "fecha_de_registro", "id", "identificador", "titulo", "ua_id", "usuario_id" FROM "Video";
DROP TABLE "Video";
